...
if ( ! function_exists( 'illdy_jumbotron_css' ) ) {
	function illdy_jumbotron_css() {
		...
		$illdy_jumbotron_general_image                  = get_theme_mod( 'illdy_jumbotron_general_image', esc_url( get_template_directory_uri() . '/layout/images/front-page/logoSite2.jpeg' ) );
		...
		if ( $illdy_jumbotron_general_image ) {
			...
			$css .= '#header.header-front-page {background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(' . esc_url( $illdy_jumbotron_general_image ) . ') !important;}';
		} else {
