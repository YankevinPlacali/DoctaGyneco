			    ...
			    <div class="container">
					<div class="carousel-caption">
						<div class="carousel-text">
							...
							<a class="enigma_blog_read_btn_slide animated bounceInDown rdm_<?php echo $i ?>" href="<?php if($wl_theme_options['slide_btn_link_'.$i]!='') { echo esc_url($wl_theme_options['slide_btn_link_'.$i]); } ?>" role="button"><i class="fa fa-sign-in"></i><?php echo esc_attr($wl_theme_options['slide_btn_text_'.$i]); ?></a>
