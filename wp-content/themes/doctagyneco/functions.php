	...
	function weblizar_default_settings()
{
	...
	$wl_theme_options=array(
			...
			'slide_title_1' => __('Votre bébé respire et vous aussi', 'enigma' ),
			'slide_desc_1' => __('car de tout coeur nous tenons à vous informer', 'enigma' ),
			'slide_btn_text_1' => __('Se connecter', 'enigma' ),
			'slide_btn_link_1' => '#',
			'slide_image_2' => $ImageUrl2,
			'slide_title_2' => __('Adopter le bon traitement', 'enigma' ),
			'slide_desc_2' => __('L\'  accompagnement proche de vous, et loin de votre poche', 'enigma' ),
			...
			'twitter_link' =>"#",
			'fb_link' =>"https://www.facebook.com/doctagynecol",
			'linkedin_link' =>"#",
			'youtube_link' =>"#",
			'instagram' =>"#",
			'gplus' =>"#",
			'vk_link' =>"#",
			'qq_link' => "#",
			'whatsapp_link' => "004917625905813",
			'whatsapp_title' => "+49 176 25905813",
			'email_id' => 'doctagyneco.com',
			'phone_no' => '004917625905813',
			...
			'service_1_title'=>__("Calcul d' ovulation",'enigma' ),
			'service_1_icons'=>"fa-plus",
			'service_1_text'=>__("Pour optimiser ses chances d' avoir un bébé, il est préférable de bien connaître son cycle, afin d' anticiper la période d' ovulation et de ...", 'enigma' ),
			'service_1_link'=>"http://doctagyneco.com/index.php/date-ovulation/",
			
			'service_2_title'=>__("Encyclopédie", 'enigma' ),
			'service_2_icons'=>"fa-user-md",
			'service_2_text'=>__("Notre encyclopédie médicale est une véritable solution à toutes vos questions de santé et controller par un médecin pour mieux vous faire ... ", 'enigma' ),
			'service_2_link'=>"http://doctagyneco.com/index.php/encyclopedie/",		

			'service_3_title'=>__('Prénoms pour bébés', 'enigma' ),
			'service_3_icons'=>"fa-child",
			'service_3_text'=>__("Le suivie de l' évolution de votre grossesse est très primordiale pour la survie et la bonne santé non seulement de votre bébé mais aussi de vous même", 'enigma' ),
			'service_3_link'=>"#",
